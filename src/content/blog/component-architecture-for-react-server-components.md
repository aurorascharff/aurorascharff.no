...
The demo app from this post is open source at [next16-social-media](https://github.com/aurorascharff/next16-social-media) if you want to explore the full codebase. I also packaged these patterns into an [agent skill](https://github.com/aurorascharff/nextjs-app-architecture-skill) you can install to have your AI coding agent follow them automatically.
