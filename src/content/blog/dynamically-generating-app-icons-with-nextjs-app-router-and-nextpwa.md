...
The icon-images are inside the `public` directory. By naming the files with the environment, we can easily differentiate between them without writing a lot of code:
